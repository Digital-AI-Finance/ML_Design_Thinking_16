...
\vspace{0.3cm}
\textbf{Root Node Gini}
Classes: 4 Yes, 2 No
$$G = 1 - \left(\frac{4}{6}\right)^2 - \left(\frac{2}{6}\right)^2 = 0.444$$
\end{column}
\begin{column}{0.48\textwidth}
\textbf{Best Split: Income $\geq$ 55k}

Left (Income < 55k): 1 Yes, 2 No
$$G_L = 1 - \left(\frac{1}{3}\right)^2 - \left(\frac{2}{3}\right)^2 = 0.444$$

Right (Income $\geq$ 55k): 3 Yes, 0 No
$$G_R = 1 - 1^2 - 0^2 = 0$$

\textbf{Information Gain}
$$IG = 0.444 - \frac{3}{6} \times 0.444 - \frac{3}{6} \times 0 = 0.222$$
