...
\begin{frame}{Slide 8: \checkmark SUCCESS: Beautiful on Spherical Clusters}
\begin{columns}[T]
\column{0.48\textwidth}
\textbf{\color{discoverblue}\checkmark K-means Excels Here}
...
\begin{frame}{Slide 9: \texttimes FAILURE PATTERN: Breaks on Non-Convex Shapes}
\begin{columns}[T]
\column{0.48\textwidth}
\textbf{\color{challengered}\texttimes K-means Fails Here}
