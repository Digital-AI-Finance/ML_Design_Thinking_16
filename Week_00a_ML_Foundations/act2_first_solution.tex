% Part 2: First Solution and Limits - Linear Models
\section{Part 2: First Solution and Limits}
...
\usebeamerfont{title}\Large Part 2: First Solution and Limits\par
\vspace{0.5em}
...
\textbf{Prediction:} \$50k + 0.1 x 1800 = \$230k
...
\begin{itemize}
\item Increase model complexity -> Bias down, Variance up
\item Decrease model complexity -> Bias up, Variance down
\end{itemize}

\vspace{0.3em}
\keypoint{The challenge: Find the sweet spot in the middle}

\textbf{Part 3 shows how to navigate this tradeoff}
...
\vspace{0.3em}
\textcolor{mlpurple}{\textbf{Part 3 reveals the breakthrough: The kernel trick and deep learning}}

\bottomnote{The evolution from linear to nonlinear is the history of modern AI}
}
\end{frame}