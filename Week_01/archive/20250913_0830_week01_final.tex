...
\begin{columns}[T]
\begin{column}{0.48\textwidth}
\Large\textbf{The Process (Step by Step):}
\normalsize
\begin{enumerate}
\item Choose K (how many groups you want)
\item Place K random centers (like putting pins on a map)
\item Assign each point to its nearest center
\item Move centers to the middle of their groups
