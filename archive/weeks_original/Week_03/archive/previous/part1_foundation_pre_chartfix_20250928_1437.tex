...
\begin{frame}[plain]
\centering
\includegraphics[width=0.95\textwidth]{charts/emotion_spectrum_heatmap.pdf}
\end{frame}
...
\includegraphics[width=\textwidth]{charts/language_emotion_flow.pdf}
\end{column}
...
\vspace{0.5em}
\includegraphics[width=\textwidth]{charts/sentiment_distribution.pdf}
\end{column}
\begin{column}{0.48\textwidth}
