...
\bottomnote{Topic modeling reveals latent structure - probabilistic decomposition exposes thematic patterns invisible through direct observation}
\end{frame}

% Include the main parts
\input{part1_hidden_patterns}
\input{part2_understanding}
\input{part3_algorithms}
\input{part4_innovation}
