% Part 1: Foundation - Why Classification? (11 slides including glossary) - BEGINNER VERSION
...
\begin{itemize}
\item Creating useful features
\item Choosing the right model
\item Finding best settings
\item Testing properly
...
% NEW Slide 10: Glossary - Key terms explained
\begin{frame}{Key Terms to Remember}
\Large\textbf{Your ML Dictionary}
\normalsize
...
\textbf{Core Concepts:}
\begin{itemize}
\item \textbf{Algorithm:} Set of rules a computer follows
\item \textbf{Model:} What the algorithm learned
\item \textbf{Training:} Teaching with examples
\item \textbf{Features:} Measurements we use
\item \textbf{Classification:} Sorting into groups
\end{itemize}

\vspace{0.5em}
\textbf{Data Terms:}
\begin{itemize}
\item \textbf{Dataset:} Collection of examples
\item \textbf{Training set:} Examples to learn from
\item \textbf{Test set:} Examples to check accuracy
\end{itemize}
\end{column}
\begin{column}{0.48\textwidth}
\textbf{Performance Terms:}
\begin{itemize}
\item \textbf{Accuracy:} \% correct overall
\item \textbf{Precision:} \% correct when predicting yes
\item \textbf{Recall:} \% of actual yes cases found
\item \textbf{Overfitting:} Memorizing instead of learning
\end{itemize}

\vspace{0.5em}
\textbf{Remember:}
\begin{tcolorbox}[colback=mlyellow!10,colframe=mlyellow]
...
% Slide 11: Transition - Bridge to technical section
