...
\centering
\includegraphics[width=0.85\textwidth]{charts/silhouette_detailed.pdf}
\vspace{0.5em}
\Large\textcolor{mlpurple}{\textbf{K=5 shows optimal cluster separation}}\\
\normalsize
...
\centering
\includegraphics[width=0.95\textwidth]{charts/clustering_algorithm_comparison.pdf}
\vspace{0.3em}
\small
...
\vspace{0.5em}
\Large\textcolor{mlpurple}{\textbf{Match algorithm to your data characteristics}}
\end{frame}
