...
\begin{center}
\includegraphics[width=0.80\textwidth]{charts/convergence_flow.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=0.7\textwidth]{charts/innovation_funnel.pdf}
\end{center}
