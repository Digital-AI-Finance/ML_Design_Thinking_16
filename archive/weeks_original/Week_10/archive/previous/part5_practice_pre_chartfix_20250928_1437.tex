...
\vspace{\fill}
\footnotesize\textcolor{mlgray}{Offline metrics are estimates—online A/B test provides ground truth}
\end{frame}
...
\vspace{\fill}
\footnotesize\textcolor{mlgray}{Pre-register hypothesis to avoid p-hacking}
\end{frame}
...
\vspace{\fill}
\footnotesize\textcolor{mlgray}{Run longer than minimum to avoid novelty effects and weekly seasonality}
\end{frame}
...
\vspace{\fill}
\footnotesize\textcolor{mlgray}{Simulation mimics real experiment—good for practice and planning}
\end{frame}
...
\vspace{\fill}
\footnotesize\textcolor{mlgray}{Both frequentist and Bayesian converge: Treatment C is clear winner}
\end{frame}
...
\vspace{\fill}
\footnotesize\textcolor{mlgray}{Clear winner with statistical + practical significance + guardrails passed}
\end{frame}
...
\vspace{\fill}
\footnotesize\textcolor{mlgray}{Gradual rollout + monitoring + rollback plan = safe deployment}
\end{frame}
...
\vspace{\fill}
\footnotesize\textcolor{mlgray}{From Week 1 empathy to Week 10 iteration—the full design thinking cycle}
\end{frame}
...
\includegraphics[width=\textwidth]{charts/continuous_improvement_loop.pdf}
...
\vspace{\fill}
\footnotesize\textcolor{mlgray}{Companies running this loop 50+ times/year outpace competitors by 3-5 years}
\end{frame}
...
\vspace{\fill}
\footnotesize\textcolor{mlgray}{Continuous iteration is your path to innovation leadership}
\end{frame}