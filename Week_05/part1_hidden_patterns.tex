...
\bottomnote{Real case: Amazon processes 1 billion reviews yearly - impossible without topic modeling}
\end{frame}
...
\bottomnote{The difference: Netflix saw patterns invisible to human categorization}
\end{frame}
...
\bottomnote{Spotify processes 4 billion user actions daily - human categorization is impossible}
\end{frame}
...
\bottomnote{Topic modeling: Turning unstructured text chaos into structured innovation opportunities}
\end{frame}