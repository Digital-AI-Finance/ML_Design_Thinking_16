...
\bottomnote{This mixing is why forcing documents into single categories loses so much information}
\end{frame}
...
\bottomnote{A topic is just a probability distribution over vocabulary - which words tend to appear together}
\end{frame}
...
\bottomnote{This mixture approach captures how humans actually write - we naturally blend topics}
\end{frame}
...
\bottomnote{Topic modeling is essentially sophisticated pattern recognition at massive scale}
\end{frame}
...
\bottomnote{Matrix decomposition: Like compressing a huge spreadsheet into its essential patterns}
\end{frame}
...
\bottomnote{Unlike classification, we don't have "correct" answers - quality is measured by usefulness}
\end{frame}
...
\bottomnote{You now understand the problem - let's see how different algorithms solve it}
\end{frame}