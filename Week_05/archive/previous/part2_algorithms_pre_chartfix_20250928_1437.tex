...
\includegraphics[width=\textwidth]{lda_plate_notation.pdf}
...
\column{0.48\textwidth}
\includegraphics[width=\textwidth]{lda_document_topics.pdf}
...
\column{0.48\textwidth}
\includegraphics[width=\textwidth]{nmf_decomposition.pdf}
...
\column{0.48\textwidth}
\includegraphics[width=\textwidth]{lsa_semantic_space.pdf}
...
\begin{columns}[T]
\column{0.55\textwidth}
\includegraphics[width=\textwidth]{topic_coherence_plot.pdf}
...
\column{0.48\textwidth}
\includegraphics[width=\textwidth]{topic_quality_dashboard.pdf}
...
\column{0.48\textwidth}
\includegraphics[width=\textwidth]{bertopic_pipeline.pdf}
