...
\column{0.48\textwidth}
\includegraphics[width=\textwidth]{data_sources_hierarchy.pdf}
...
\vspace{0.3cm}
\includegraphics[width=\textwidth]{nmf_topics_visualization.pdf}
\end{columns}
\end{frame}
...
\includegraphics[width=\textwidth]{pyldavis_example.pdf}
...
\includegraphics[width=\textwidth]{topic_heatmap.pdf}
...
\begin{columns}[T]
\column{0.55\textwidth}
\includegraphics[width=\textwidth]{hyperparameter_grid.pdf}
...
\column{0.48\textwidth}
\includegraphics[width=\textwidth]{realtime_architecture.pdf}
