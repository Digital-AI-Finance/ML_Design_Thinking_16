...
\includegraphics[width=0.85\textwidth]{charts/precision_recall_tradeoff.pdf}
...
\begin{columns}[T]
\column{0.55\textwidth}
\includegraphics[width=0.85\textwidth]{charts/f_beta_family.pdf}
...
\vspace{\fill}
\footnotesize\textcolor{mlgray}{Beta parameter encodes error cost asymmetry - weighting reflects relative importance of false positive versus false negative consequences}
\end{frame}
...
\column{0.48\textwidth}
\includegraphics[width=0.85\textwidth]{charts/roc_curve_explained.pdf}
...
\begin{columns}[T]
\column{0.55\textwidth}
\includegraphics[width=0.85\textwidth]{charts/auc_interpretation.pdf}
...
\column{0.48\textwidth}
\includegraphics[width=0.85\textwidth]{charts/pr_vs_roc.pdf}
...
\begin{columns}[T]
\column{0.55\textwidth}
\includegraphics[width=0.85\textwidth]{charts/multi_class_strategies.pdf}
...
\vspace{\fill}
\footnotesize\textcolor{mlgray}{Practical implementation translates mathematical definitions into code - library functions enable metric calculation within production validation pipelines}
\end{frame}