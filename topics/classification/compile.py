#!/usr/bin/env python3
"""
Automated LaTeX compilation with cleanup for Week 4 presentation.
...
def main():
    ...
    print("=" * 50)
    print("Week 4 LaTeX Compilation Tool")
    print("Classification & Definition")
    print("=" * 50)
    ...
    try:
        ...
        print(f"ERROR: {e}")
        print("Please ensure you're in the Week_04 directory and main.tex exists")
        return 1
    except Exception as e:
