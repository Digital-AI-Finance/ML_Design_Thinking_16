...
\includegraphics[width=0.85\textwidth]{charts/fairness_toolkit_comparison.pdf}
...
\begin{columns}[T]
\column{0.55\textwidth}
\includegraphics[width=0.85\textwidth]{charts/shap_explanation_example.pdf}
...
\begin{columns}[T]
\column{0.55\textwidth}
\includegraphics[width=0.85\textwidth]{charts/model_card_template.pdf}
...
\begin{columns}[T]
\column{0.55\textwidth}
\includegraphics[width=0.85\textwidth]{charts/privacy_techniques.pdf}
