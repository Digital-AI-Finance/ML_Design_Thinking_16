...
\includegraphics[width=\textwidth]{charts/fairness_metrics_comparison.pdf}
...
\begin{columns}[T]
\column{0.55\textwidth}
\includegraphics[width=\textwidth]{charts/demographic_parity.pdf}
...
\begin{columns}[T]
\column{0.55\textwidth}
\includegraphics[width=\textwidth]{charts/equal_opportunity.pdf}
...
\begin{columns}[T]
\column{0.55\textwidth}
\includegraphics[width=\textwidth]{charts/bias_detection_workflow.pdf}
