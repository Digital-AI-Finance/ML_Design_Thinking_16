...
\includegraphics[width=0.85\textwidth]{charts/data_sources_pyramid.pdf}
\end{column}
...
\vspace{0.5em}
\includegraphics[width=0.85\textwidth]{charts/text_cleaning_pipeline.pdf}
\end{frame}
...
\end{column}
\begin{column}{0.43\textwidth}
\includegraphics[width=0.85\textwidth]{charts/feature_engineering_nlp.pdf}
\end{column}
\end{columns}
\end{frame}
...
\end{column}
\begin{column}{0.48\textwidth}
\includegraphics[width=0.85\textwidth]{charts/batch_processing_speed.pdf}
\vspace{0.5em}
\includegraphics[width=0.85\textwidth]{charts/gpu_cpu_comparison.pdf}
\end{column}
\end{columns}
\end{frame}
...
\vspace{0.5em}
\includegraphics[width=0.85\textwidth]{charts/api_integration_flow.pdf}
\end{column}
\end{columns}
\end{frame}