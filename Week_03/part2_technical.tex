...
\includegraphics[width=0.85\textwidth]{charts/tokenization_examples.pdf}
\end{column}
\end{columns}
\end{frame}
...
\begin{columns}[T]
\begin{column}{0.55\textwidth}
\includegraphics[width=0.85\textwidth]{charts/word_embedding_space.pdf}
\end{column}
\begin{column}{0.43\textwidth}
...
\end{column}
\begin{column}{0.43\textwidth}
\includegraphics[width=0.85\textwidth]{charts/confusion_matrix.pdf}
\vspace{0.5em}
\includegraphics[width=0.85\textwidth]{charts/roc_curves.pdf}
\end{column}
\end{columns}
\end{frame}
...
\begin{columns}[T]
\begin{column}{0.55\textwidth}
\includegraphics[width=0.85\textwidth]{charts/imbalanced_sentiment.pdf}
\end{column}
\begin{column}{0.43\textwidth}
