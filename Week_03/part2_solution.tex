...
\bottomnote{This ``Bag of Words'' approach dominated NLP from 1960s-2010s - let's see why}
\end{frame}
...
\bottomnote{Bag of Words: Treats text like a bag of marbles - count colors, ignore arrangement}
\end{frame}
...
\bottomnote{TF-IDF: The Google PageRank of words - importance comes from being special, not just frequent}
\end{frame}
...
\bottomnote{Success case: Direct, literal language with clear emotion words - the ``easy'' 20\% of reviews}
\end{frame}
...
\bottomnote{80\% of real reviews have complexity that breaks traditional NLP - this is the crisis point}
\end{frame}
...
\bottomnote{The Bag of Words throws away 82\% of information - like reading a book with random page order}
\end{frame}