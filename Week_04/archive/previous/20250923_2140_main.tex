...
\vspace{1em}
\begin{enumerate}
\item \textbf{Foundation: Why Classification?} (10 slides)\\
\textit{Understanding the problem and opportunity}

\vspace{0.5em}
\item \textbf{Algorithms: How It Works} (12 slides)\\
\textit{Core technical understanding of classification methods}

\vspace{0.5em}
\item \textbf{Implementation: Making It Work} (12 slides)\\
\textit{From theory to production-ready systems}

\vspace{0.5em}
\item \textbf{Design Integration: User Experience} (11 slides)\\
\textit{Human-centered application and practice}
\end{enumerate}

\vspace{1em}
\begin{center}
\textbf{Plus: Mathematical Appendix} (3 slides)
\end{center}
\end{frame}

% Include the four main parts
\input{part1_foundation_v2}
\input{part2_algorithms_v2}
\input{part3_implementation_v2}
