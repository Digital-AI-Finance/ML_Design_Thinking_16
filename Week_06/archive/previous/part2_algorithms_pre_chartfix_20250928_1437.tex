...
\begin{columns}[T]
\column{0.55\textwidth}
\includegraphics[width=\textwidth]{vae_latent_space.pdf}
...
\begin{columns}[T]
\column{0.55\textwidth}
\includegraphics[width=\textwidth]{diffusion_process.pdf}
...
\begin{columns}[T]
\column{0.55\textwidth}
\includegraphics[width=\textwidth]{transformer_attention.pdf}
...
\begin{columns}[T]
\column{0.55\textwidth}
\includegraphics[width=\textwidth]{quality_vs_speed_tradeoff.pdf}
